  ...
  return {
    ...
    addListItem: function(obj, type) {
      ...
      if (type === 'inc') {
        ...
        html = '<div class="item clearfix" id="exp-%id%"> <div class="item__description">%description%</div> <div class="right clearfix"> <div class="item__value">- 900.00</div> <div class="item__percentage">%value%</div> <div class="item__delete"> <button class="item__delete--btn"><i class="ion-ios-close-outline"></i></button> </div> </div> </div>';
      }
    ...
    displayPercentages: function(percentage) {
      ...
      nodeListForEach(fields, function(current, index) {
        if (percentages[index] > 0) {
          current.textContext = percentages[index] + '%';
        } else {
          current.textContext = '---';
        }
      });
